// ============================================================
// kgfcm-devotion-generate-v2 — Daily pastoral devotion drafter.
//
// This is the ACTIVE devotion function: the pg_cron job
// kgfcm_daily_devotion posts here, per migration
// 20260530180000_devotion_cron_point_at_v2.sql. The -v2 slug
// exists only because the original kgfcm-devotion-generate slug
// entered a stuck state on the Supabase deploys API (identical
// payloads 500'd under that slug and deployed cleanly under a
// new one).
//
// This file must stay byte-identical to
// ../kgfcm-devotion-generate/index.ts apart from this header.
// The slug is the only intended difference. If the two diverge,
// production is running whichever one the cron points at — check
// the migration above before assuming.
//
